...
sequenceData = load_data("Sixpence sequence.txt")
...
model.save("learnedModelGRU.h5")
dump(dictionary, open("../Text Files and Dictionary/dictionarySP.pkl", "wb"))

newmodel = load_model("learnedModelGRU.h5")
newdictionary = load(open("../Text Files and Dictionary/dictionarySP.pkl", "rb"))
...
print(generateSeq(newmodel, 15, 30,"Sing a song of "))
print(generateSeq(newmodel, 15, 30,"A pocket full o"))
print(generateSeq(newmodel, 15, 30,"maid was in the"))
print(generateSeq(newmodel, 15, 30,"maid was out in"))
